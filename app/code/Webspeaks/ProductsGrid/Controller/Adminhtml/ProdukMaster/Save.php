...
namespace Webspeaks\ProductsGrid\Controller\Adminhtml\ProdukMaster;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Webspeaks\ProductsGrid\Model\ResourceModel\MasterProduct\CollectionFactory
     */
    ...
    public function __construct(
        Context $context,
        \Magento\Backend\Helper\Js $jsHelper,
        \Webspeaks\ProductsGrid\Model\ResourceModel\MasterProduct\CollectionFactory $contactCollectionFactory
    ) {
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            /** @var \Webspeaks\ProductsGrid\Model\MasterProduct $model */
            $model = $this->_objectManager->create('Webspeaks\ProductsGrid\Model\MasterProduct');
    ...
    public function saveProducts($model, $post)
    {
        ...
        if (isset($post['products'])) {
            ...
            try {
                ...
                $table = $this->_resources->getTableName(\Webspeaks\ProductsGrid\Model\ResourceModel\MasterProduct::TBL_ATT_PRODUCT);
