...
class MasterProduct extends \Magento\Framework\Model\AbstractModel implements IdentityInterface
{
    ...
    {
        $this->_init('Webspeaks\ProductsGrid\Model\ResourceModel\MasterProduct');
    }
    ...
    public function getProducts(\Webspeaks\ProductsGrid\Model\MasterProduct $object)
    {
        $tbl = $this->getResource()->getTable(\Webspeaks\ProductsGrid\Model\ResourceModel\MasterProduct::TBL_ATT_PRODUCT);
