...
namespace Magento\CatalogML\Ui\Component\Listing\Column;
...
{
    /** Url path */
    const CONTACTS_URL_PATH_EDIT = 'mlprodukgrid/contacts/edit';
    const CONTACTS_URL_PATH_DELETE = 'mlprodukgrid/contacts/delete';
