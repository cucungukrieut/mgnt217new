<?php
namespace Magento\ImportGroupingWarnaML\Model\Import;

use Magento\ImportGroupingWarnaML\Model\Import\ImportGroupingWarnaML\RowValidatorInterface as ValidatorInterface;
