 ...
 */
class Export extends \Magento\ImportProducts\Model\AbstractModel
{
     ...
     * Entity adapter.
     *
     * @var \Magento\ImportProducts\Model\Export\Entity\AbstractEntity
     */
     ...
     *
     * @var \Magento\ImportProducts\Model\Export\Adapter\AbstractAdapter
     */
    protected $_writer;
    ...
    /**
     * @var \Magento\ImportProducts\Model\Export\Entity\Factory
     */
    protected $_entityFactory;

    /**
     * @var \Magento\ImportProducts\Model\Export\Adapter\Factory
     */
     ...
     * @param \Magento\ImportProducts\Model\Export\Entity\Factory $entityFactory
     * @param \Magento\ImportProducts\Model\Export\Adapter\Factory $exportAdapterFac
     * @param array $data
     */
    public function __construct(
        \Psr\Log\LoggerInterface $logger,
        \Magento\Framework\Filesystem $filesystem,
        \Magento\ImportProducts\Model\Export\ConfigInterface $exportConfig,
        \Magento\ImportProducts\Model\Export\Entity\Factory $entityFactory,
        \Magento\ImportProducts\Model\Export\Adapter\Factory $exportAdapterFac,
        array $data = []
    ) {
     ...
     *
     * @return \Magento\ImportProducts\Model\Export\Entity\AbstractEntity|\Magento\ImportProducts\Model\Export\AbstractEntity
    ...
    protected function _getEntityAdapter()
    {
        if (!$this->_entityAdapter) {
            ...
            if (isset($entities[$this->getEntity()])) {
                ...
                if (!$this->_entityAdapter instanceof \Magento\ImportProducts\Model\Export\Entity\AbstractEntity &&
                    !$this->_entityAdapter instanceof \Magento\ImportProducts\Model\Export\AbstractEntity
                ) {
                    throw new \Magento\Framework\Exception\LocalizedException(
                        __(
                            'The entity adapter object must be an instance of %1 or %2.',
                            'Magento\ImportProducts\Model\Export\Entity\AbstractEntity',
     ...
     * Get writer object.
     *
     * @return \Magento\ImportProducts\Model\Export\Adapter\AbstractAdapter
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    protected function _getWriter()
    {
        if (!$this->_writer) {
            ...
            if (isset($fileFormats[$this->getFileFormat()])) {
                ...
                if (!$this->_writer instanceof \Magento\ImportProducts\Model\Export\Adapter\AbstractAdapter) {
                    throw new \Magento\Framework\Exception\LocalizedException(
                        __(
    ...
    public function getFileName()
    {
        ...
        if ($entityAdapter instanceof \Magento\ImportProducts\Model\Export\AbstractEntity) {
