...
use Magento\ImportProducts\Model\Export as ExportModel;
...
class Export extends ExportController
{
    ...
    public function execute()
    {
        if ($this->getRequest()->getPost(ExportModel::FILTER_ELEMENT_GROUP)) {
            try {
                /** @var $model \Magento\ImportProducts\Model\Export */
                $model = $this->_objectManager->create('Magento\ImportProducts\Model\Export');
