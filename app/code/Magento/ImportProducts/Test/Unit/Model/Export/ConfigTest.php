...
class ConfigTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Magento\ImportProducts\Model\Export\Config
     */
    protected $_model;
    ...
    protected function setUp()
    {
        $this->_readerMock = $this->getMock(
            'Magento\ImportProducts\Model\Export\Config\Reader',
            [],
            [],
            '',
            false
    ...
    public function testGetEntities($value, $expected)
    {
        ...
        $this->_model = new \Magento\ImportProducts\Model\Export\Config(
            $this->_readerMock,
