 ...
 */
namespace Magento\ImportProducts\Test\Unit\Block\Adminhtml\Export;
...
class FilterTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Magento\ImportProducts\Block\Adminhtml\Export\Filter|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $filter;
    ...
    protected function setUp()
    {
        ...
        $this->ImportProductsData = $this->getMock('Magento\ImportProducts\Helper\Data', [], [], '', false);
        ...
        $this->filter = $this->objectManagerHelper->getObject(
            ...
            [
                ...
                'ImportProductsData' => $this->ImportProductsData
            ]
        );
    }
