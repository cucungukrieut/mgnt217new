...
class Filter extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected $_filterTypeByAttrCode = [
        'updated_at' => \Magento\ImportProducts\Model\Export::FILTER_TYPE_DATE,
    ];
    ...
    protected function _construct()
    {
        ...
        $this->_helper = $this->_ImportProductsData;
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'type' => 'checkbox',
                'name' => 'skip',
                'field_name' => \Magento\ImportProducts\Model\Export::FILTER_ELEMENT_SKIP . '[]',
                'filter' => false,
                'sortable' => false,
                'index' => 'attribute_id',
    ...
    public function decorateFilter($value, Attribute $row, \Magento\Framework\DataObject $column, $isExport)
    {
        ...
        if (isset($this->_filterTypeByAttrCode[$code])) {
            ...
            $filterType = \Magento\ImportProducts\Model\Export::getAttributeFilterType($row);
        }

        switch ($filterType) {
            case \Magento\ImportProducts\Model\Export::FILTER_TYPE_SELECT:
                $cell = $this->_getSelectHtmlWithValue($row, $value);
                break;
            case \Magento\ImportProducts\Model\Export::FILTER_TYPE_INPUT:
                $cell = $this->_getInputHtmlWithValue($row, $value);
                break;
            case \Magento\ImportProducts\Model\Export::FILTER_TYPE_DATE:
                $cell = $this->_getDateFromToHtmlWithValue($row, $value);
                break;
            case \Magento\ImportProducts\Model\Export::FILTER_TYPE_NUMBER:
    ...
    {
        return \Magento\ImportProducts\Model\Export::FILTER_ELEMENT_GROUP . "_{$attributeCode}";
    }
    ...
    {
        return \Magento\ImportProducts\Model\Export::FILTER_ELEMENT_GROUP . "[{$attributeCode}]";
    }
