...
namespace Magento\FastSimpleImport\Model\Import;

use Magento\FastSimpleImport\Helper\Config;
use Magento\FastSimpleImport\Model\Enterprise\VersionFeaturesFactory;
use Magento\FastSimpleImport\Model\Import\Proxy\Category\ResourceModelFactory as CategoryResourceModelFactory;
use Magento\FastSimpleImport\ResourceModel\Import\Category\StorageFactory;
use Magento\FastSimpleImport\Model\Enterprise\CategoryImportVersion;
...
class Category extends \Magento\ImportExport\Model\Import\AbstractEntity
{
    ...
    /**
     * @var \Magento\FastSimpleImport\ResourceModel\Import\Category\StorageFactory
     */
