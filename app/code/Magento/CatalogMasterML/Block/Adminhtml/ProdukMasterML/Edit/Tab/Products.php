...
use Magento\CatalogMasterML\Model\ContactFactory;
...
class Products extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        /* @var $model \Magento\CatalogMasterML\Model\Slide */
        $model = $this->_objectManager->get('\Magento\CatalogMasterML\Model\ProdukMasterML');
