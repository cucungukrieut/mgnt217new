...
class Save extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Magento\CatalogMasterML\Model\ResourceModel\ProdukMasterML\CollectionFactory
     */
    ...
    public function __construct(
        Context $context,
        \Magento\Backend\Helper\Js $jsHelper,
        \Magento\CatalogMasterML\Model\ResourceModel\ProdukMasterML\CollectionFactory $collectionFactory
    ) {
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            /** @var \Magento\CatalogMasterML\Model\ProdukMasterML $model */
            $model = $this->_objectManager->create('Magento\CatalogMasterML\Model\ProdukMasterML');
