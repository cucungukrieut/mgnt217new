...
use \Magento\ProdukML\Model\ResourceModel\Contact;
...
class Save extends Action
{
    ...
    /**
     * @var \Magento\ProdukML\Model\ResourceModel\Contact\CollectionFactory
     */
    ...
    public function __construct(Context $context, Js $jsHelper,
        \Magento\ProdukML\Model\ResourceModel\Contact\CollectionFactory $contactCollectionFactory //
    ) {
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            /** @var \Magento\ProdukML\Model\Contact $model */
