...
namespace Magento\MuliaCatalogImport\Test\Unit\Model\Import\Product\Validator;

use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManagerHelper;

class TierPriceTest extends \PHPUnit_Framework_TestCase
{
    /** @var \Magento\MuliaCatalogImport\Model\Import\Product\Validator\TierPrice */
    protected $tierPrice;
    ...
    protected function setUp()
    {
        ...
        $this->storeResolver = $this->getMock(
            'Magento\MuliaCatalogImport\Model\Import\Product\StoreResolver',
            [],
            [],
            '',
            false
        ...
        $this->tierPrice = $this->objectManagerHelper->getObject(
            'Magento\MuliaCatalogImport\Model\Import\Product\Validator\TierPrice',
            [
