...
class ValidatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->validatorOne = $this->getMock(
            'Magento\MuliaCatalogImport\Model\Import\Product\Validator\Media',
            [],
            [],
            '',
            false
        ...
        $this->validatorTwo = $this->getMock(
            'Magento\MuliaCatalogImport\Model\Import\Product\Validator\Website',
            [],
            [],
            '',
            false
        ...
        $this->validator = $this->objectManagerHelper->getObject(
            'Magento\MuliaCatalogImport\Model\Import\Product\Validator',
