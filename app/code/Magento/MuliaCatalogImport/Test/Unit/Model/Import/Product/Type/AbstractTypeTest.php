...
use Magento\MuliaCatalogImport\Model\Import\Product\Type\AbstractType as AbstractType;
...
{
    /**
     * @var \Magento\MuliaCatalogImport\Model\Import\Product|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $entityModel;

    /**
     * @var \Magento\MuliaCatalogImport\Model\Import\Product\Type\Simple
     */
    ...
    protected function setUp()
    {
        $this->entityModel = $this->getMock(
            '\Magento\MuliaCatalogImport\Model\Import\Product',
            [],
            [],
            '',
            false
        ...
        $this->simpleType = $this->objectManagerHelper->getObject(
            'Magento\MuliaCatalogImport\Model\Import\Product\Type\Simple',
            [
    ...
    public function testIsRowValidSuccess()
    {
        ...
        $this->setPropertyValue($this->simpleType, '_attributes', [
            $rowData[\Magento\MuliaCatalogImport\Model\Import\Product::COL_ATTR_SET] => [],
        ]);
    ...
    public function testIsRowValidError()
    {
        ...
        $this->entityModel->expects($this->once())->method('addRowError')
            ->with(
                \Magento\MuliaCatalogImport\Model\Import\Product\RowValidatorInterface::ERROR_VALUE_IS_REQUIRED,
                1,
                'attr_code'
            )
            ->willReturnSelf();
