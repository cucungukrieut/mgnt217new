 ...
 */
namespace Magento\MuliaCatalogImport\Test\Unit\Model\Import\Product\Type;
...
class OptionTest extends \Magento\ImportExport\Test\Unit\Model\Import\AbstractImportTestCase
{
     ...
     * Test entity
     *
     * @var \Magento\MuliaCatalogImport\Model\Import\Product\Option
     */
    protected $model;
    ...
    protected function setUp()
    {
        ...
        $modelClassName = \Magento\MuliaCatalogImport\Model\Import\Product\Option::class;
        ...
        $this->modelMock = $this->getMockBuilder($modelClassName)
            ...
            ->getMock();
        $reflection = new \ReflectionClass(\Magento\MuliaCatalogImport\Model\Import\Product\Option::class);
        ...
        foreach ($csvData['data'] as $rowIndex => $csvDataRow) {
            if (!empty($csvDataRow['sku']) && !array_key_exists($csvDataRow['sku'], $products)) {
                ...
                $products[$csvDataRow['sku']] = [
                    ...
                    'type' => $csvDataRow[\Magento\MuliaCatalogImport\Model\Import\Product::COL_TYPE],
                    'title' => $csvDataRow[\Magento\MuliaCatalogImport\Model\Import\Product::COL_NAME]
                ];
            }
        }
    ...
    /**
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::getEntityTypeCode
     */
    ...
    /**
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::importData
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_importData
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_saveOptions
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_saveTitles
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_savePrices
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_saveSpecificTypeValues
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_saveSpecificTypePrices
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_saveSpecificTypeTitles
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_updateProducts
     */
    ...
    /**
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_importData
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_deleteEntities
     */
     ...
     *
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_isRowWithCustomOption
     */
     ...
     * @param array $errors
     *
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::validateRow
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_isRowWithCustomOption
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_isMainOptionRow
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_isSecondaryOptionRow
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_validateMainRow
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_validateMainRowAdditionalData
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_validateSecondaryRow
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_validateSpecificTypeParameters
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_validateSpecificParameterData
     ...
     *
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::validateAmbiguousData
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_findNewOptionsWithTheSameTitles
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_findOldOptionsWithTheSameTitles
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_findNewOldOptionsTypeMismatch
     * @covers \Magento\MuliaCatalogImport\Model\Import\Product\Option::_saveNewOptionData
    ...
    public function validateRowDataProvider()
    {
        return [
            ...
            'main_invalid_store' => [
                ...
                '$errors' => [
                    \Magento\MuliaCatalogImport\Model\Import\Product\Option::ERROR_INVALID_STORE => [1]
                ]
            ],
            'main_incorrect_type' => [
                '$rowData' => include __DIR__ . '/_files/row_data_main_incorrect_type.php',
                '$errors' => [
                    \Magento\MuliaCatalogImport\Model\Import\Product\Option::ERROR_INVALID_TYPE => [1]
                ]
            ],
            'main_no_title' => [
                '$rowData' => include __DIR__ . '/_files/row_data_main_no_title.php',
                '$errors' => [
                    \Magento\MuliaCatalogImport\Model\Import\Product\Option::ERROR_EMPTY_TITLE => [1]
                ]
            ],
            'main_empty_title' => [
            ...
            'main_invalid_price' => [
                ...
                '$errors' => [
                    \Magento\MuliaCatalogImport\Model\Import\Product\Option::ERROR_INVALID_PRICE => [1]
                ]
            ],
            'main_invalid_max_characters' => [
                '$rowData' => include __DIR__ . '/_files/row_data_main_invalid_max_characters.php',
                '$errors' => [
                    \Magento\MuliaCatalogImport\Model\Import\Product\Option::ERROR_INVALID_MAX_CHARACTERS => [1]
                ]
            ],
            ...
            'main_invalid_sort_order' => [
                ...
                '$errors' => [
                    \Magento\MuliaCatalogImport\Model\Import\Product\Option::ERROR_INVALID_SORT_ORDER => [1]
                ]
            ],
            ...
            'secondary_incorrect_price' => [
                ...
                '$errors' => [
                    \Magento\MuliaCatalogImport\Model\Import\Product\Option::ERROR_INVALID_ROW_PRICE => [1]
                ]
            ],
            'secondary_incorrect_row_sort' => [
                '$rowData' => include __DIR__ . '/_files/row_data_secondary_incorrect_row_sort.php',
                '$errors' => [
                    \Magento\MuliaCatalogImport\Model\Import\Product\Option::ERROR_INVALID_ROW_SORT => [1]
                ]
            ],
    ...
    public function validateAmbiguousDataDataProvider()
    {
        return [
            'ambiguity_several_input_rows' => [
                '$rowData' => include __DIR__ . '/_files/row_data_main_valid.php',
                '$errors' => [
                    \Magento\MuliaCatalogImport\Model\Import\Product\Option::ERROR_AMBIGUOUS_NEW_NAMES => [2, 2]
                ],
                '$behavior' => null,
            ...
            'ambiguity_different_type' => [
                ...
                '$errors' => [
                    \Magento\MuliaCatalogImport\Model\Import\Product\Option::ERROR_AMBIGUOUS_TYPES => [1]
                ],
            ...
            'ambiguity_several_db_rows' => [
                ...
                '$errors' => [
                    \Magento\MuliaCatalogImport\Model\Import\Product\Option::ERROR_AMBIGUOUS_OLD_NAMES => [1]
                ],
                '$behavior' => \Magento\ImportExport\Model\Import::BEHAVIOR_APPEND
            ]
        ];
    ...
    public function testParseRequiredData()
    {
        ...
        /** @var \Magento\MuliaCatalogImport\Model\Import\Product $productEntityMock */
        ...
        /** @var \Magento\MuliaCatalogImport\Model\Import\Product\Option $model */
        $model = $this->objectManagerHelper->getObject(
            \Magento\MuliaCatalogImport\Model\Import\Product\Option::class,
            [
                'data' => [
