...
class UploaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Magento\MuliaCatalogImport\Model\Import\Uploader|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $uploader;
    ...
    protected function setUp()
    {
        ...
        $this->uploader = $this->getMockBuilder(\Magento\MuliaCatalogImport\Model\Import\Uploader::class)
            ->setConstructorArgs([
