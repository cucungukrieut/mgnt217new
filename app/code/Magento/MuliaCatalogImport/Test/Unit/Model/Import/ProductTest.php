 ...
 */
namespace Magento\MuliaCatalogImport\Test\Unit\Model\Import;
...
/**
 * Class ProductTest
 * @package Magento\MuliaCatalogImport\Test\Unit\Model\Import
...
class ProductTest extends \Magento\ImportExport\Test\Unit\Model\Import\AbstractImportTestCase
{
    ...
    /** @var \Magento\MuliaCatalogImport\Model\Import\Product\OptionFactory|\PHPUnit_Framework_MockObject_MockObject */
    ...
    /** @var \Magento\MuliaCatalogImport\Model\Import\Product\Option|\PHPUnit_Framework_MockObject_MockObject */
    ...
    /** @var  \Magento\MuliaCatalogImport\Model\Import\Product\Type\Factory|\PHPUnit_Framework_MockObject_MockObject */
    protected $_productTypeFactory;

    /** @var  \Magento\Catalog\Model\ResourceModel\Product\LinkFactory|\PHPUnit_Framework_MockObject_MockObject */
    protected $_linkFactory;

    /** @var  \Magento\MuliaCatalogImport\Model\Import\Proxy\ProductFactory|\PHPUnit_Framework_MockObject_MockObject */
    protected $_proxyProdFactory;

    /** @var  \Magento\MuliaCatalogImport\Model\Import\UploaderFactory|\PHPUnit_Framework_MockObject_MockObject */
    ...
    /** @var  \Magento\MuliaCatalogImport\Model\Import\Product\StoreResolver|\PHPUnit_Framework_MockObject_MockObject */
    protected $storeResolver;

    /** @var  \Magento\MuliaCatalogImport\Model\Import\Product\SkuProcessor|\PHPUnit_Framework_MockObject_MockObject */
    protected $skuProcessor;

    /** @var  \Magento\MuliaCatalogImport\Model\Import\Product\CategoryProcessor|\PHPUnit_Framework_MockObject_MockObject */
    protected $categoryProcessor;

    /** @var  \Magento\MuliaCatalogImport\Model\Import\Product\Validator|\PHPUnit_Framework_MockObject_MockObject */
    protected $validator;
    ...
    protected function setUp()
    {
        ...
        $this->_resourceFactory = $this->getMock(
            \Magento\MuliaCatalogImport\Model\Import\Proxy\Product\ResourceModelFactory::class,
            ['create'],
            [],
            '',
            false
        ...
        $this->_productTypeFactory = $this->getMock(
            \Magento\MuliaCatalogImport\Model\Import\Product\Type\Factory::class,
            ['create'],
            [],
            '',
            false
        ...
        $this->_proxyProdFactory = $this->getMock(
            \Magento\MuliaCatalogImport\Model\Import\Proxy\ProductFactory::class,
            ['create'],
            [],
            '',
            false
        ...
        $this->_uploaderFactory = $this->getMock(
            \Magento\MuliaCatalogImport\Model\Import\UploaderFactory::class,
            ['create'],
            [],
            '',
            false
        ...
        $this->_logger =
            $this->getMockBuilder(\Psr\Log\LoggerInterface::class)
                ->getMock();
        $this->storeResolver =
            $this->getMockBuilder(\Magento\MuliaCatalogImport\Model\Import\Product\StoreResolver::class)
                ->setMethods([
                    'getStoreCodeToId',
                ])
                ->disableOriginalConstructor()
                ->getMock();
        $this->skuProcessor =
            $this->getMockBuilder(\Magento\MuliaCatalogImport\Model\Import\Product\SkuProcessor::class)
                ->disableOriginalConstructor()
                ->getMock();
        $reflection = new \ReflectionClass(\Magento\MuliaCatalogImport\Model\Import\Product\SkuProcessor::class);
        $reflectionProperty = $reflection->getProperty('metadataPool');
        $reflectionProperty->setAccessible(true);
        $reflectionProperty->setValue($this->skuProcessor, $metadataPoolMock);

        $this->categoryProcessor =
            $this->getMockBuilder(\Magento\MuliaCatalogImport\Model\Import\Product\CategoryProcessor::class)
                ->disableOriginalConstructor()
                ->getMock();
        $this->validator =
            $this->getMockBuilder(\Magento\MuliaCatalogImport\Model\Import\Product\Validator::class)
        ...
        $this->taxClassProcessor =
            $this->getMockBuilder(\Magento\MuliaCatalogImport\Model\Import\Product\TaxClassProcessor::class)
                ->disableOriginalConstructor()
                ->getMock();
        ...
        $this->importProduct = $objectManager->getObject(
            \Magento\MuliaCatalogImport\Model\Import\Product::class,
            [
        ...
        $reflection = new \ReflectionClass(\Magento\MuliaCatalogImport\Model\Import\Product::class);
        $reflectionProperty = $reflection->getProperty('metadataPool');
        $reflectionProperty->setAccessible(true);
    ...
    protected function _objectConstructor()
    {
        $this->optionFactory = $this->getMock(
            \Magento\MuliaCatalogImport\Model\Import\Product\OptionFactory::class,
            ['create'],
            [],
            '',
            false
        );
        $this->optionEntity = $this->getMockBuilder(\Magento\MuliaCatalogImport\Model\Import\Product\Option::class)
    ...
    protected function _initTypeModels()
    {
        ...
        $productTypeInstance =
            $this->getMockBuilder(\Magento\MuliaCatalogImport\Model\Import\Product\Type\AbstractType::class)
                ->disableOriginalConstructor()->getMock();
    ...
    public function testSaveProductAttributes()
    {
        ...
        $resource = $this->getMockBuilder(\Magento\MuliaCatalogImport\Model\Import\Proxy\Product\ResourceModel::class)
            ->disableOriginalConstructor()
            ->setMethods(['getTable'])
            ->getMock();
    ...
    {
        $importProduct = $this->getMockBuilder(\Magento\MuliaCatalogImport\Model\Import\Product::class)
            ->disableOriginalConstructor()
            ->setMethods([
    ...
    public function testValidateRow($rowScope, $oldSku, $expectedResult, $behaviour = Import::BEHAVIOR_DELETE)
    {
        ...
        $skuKey = \Magento\MuliaCatalogImport\Model\Import\Product::COL_SKU;
        $rowData = [
            $skuKey => 'sku',
        ];
    ...
    public function testValidateRowDeleteBehaviourAddRowErrorCall()
    {
        ...
        $importProduct->expects($this->once())->method('getRowScope')
            ->willReturn(\Magento\MuliaCatalogImport\Model\Import\Product::SCOPE_DEFAULT);
        $importProduct->expects($this->once())->method('addRowError');
        $rowData = [
            \Magento\MuliaCatalogImport\Model\Import\Product::COL_SKU => 'sku',
        ];
    ...
    public function getStoreIdByCodeDataProvider()
    {
        return [
            [
                '$storeCode' => null,
                '$expectedResult' => \Magento\MuliaCatalogImport\Model\Import\Product::SCOPE_DEFAULT,
            ],
            [
                '$storeCode' => 'value',
    ...
    public function testValidateRowCheckSpecifiedSku($sku, $expectedError)
    {
        ...
        $rowData = [
            \Magento\MuliaCatalogImport\Model\Import\Product::COL_SKU => $sku,
            \Magento\MuliaCatalogImport\Model\Import\Product::COL_STORE => '',
        ];
        ...
        $importProduct
            ->expects($this->once())
            ->method('getRowScope')
            ->willReturn(\Magento\MuliaCatalogImport\Model\Import\Product::SCOPE_STORE);
    ...
    public function testValidateRowProcessEntityIncrement()
    {
        ...
        $rowData = [\Magento\MuliaCatalogImport\Model\Import\Product::COL_SKU => false];
        //suppress validator
    ...
    public function testValidateRowValidateExistingProductTypeAddErrorRowCall()
    {
        ...
        $importProduct->expects($this->once())->method('addRowError')->with(
            \Magento\MuliaCatalogImport\Model\Import\Product\Validator::ERROR_TYPE_UNSUPPORTED,
            $rowNum
        );
    ...
    public function testValidateRowValidateExistingProductTypeResetSku()
    {
        ...
        $this->setPropertyValue($importProduct, 'skuProcessor', $this->skuProcessor);
        $productType = $this->getMockBuilder(\Magento\MuliaCatalogImport\Model\Import\Product\Type\AbstractType::class)
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testValidateRowValidateNewProductTypeAddRowErrorCall(
        ...
        $rowData = [
            \Magento\MuliaCatalogImport\Model\Import\Product::COL_SKU => $sku,
            \Magento\MuliaCatalogImport\Model\Import\Product::COL_TYPE => $colType,
            \Magento\MuliaCatalogImport\Model\Import\Product::COL_ATTR_SET => $colAttrSet,
        ];
        $_attrSetNameToId = [
            $rowData[\Magento\MuliaCatalogImport\Model\Import\Product::COL_ATTR_SET] => $attrSetNameToIdColAttrSet,
        ];
        $_productTypeModels = [
            $rowData[\Magento\MuliaCatalogImport\Model\Import\Product::COL_TYPE] => $productTypeModelsColType,
        ];
        $oldSku = [
            $sku => null,
        ];
    ...
    public function testValidateRowValidateNewProductTypeGetNewSkuCall()
    {
        ...
        $rowData = [
            \Magento\MuliaCatalogImport\Model\Import\Product::COL_SKU => $sku,
            \Magento\MuliaCatalogImport\Model\Import\Product::COL_TYPE => 'value',
            \Magento\MuliaCatalogImport\Model\Import\Product::COL_ATTR_SET => 'value',
        ];
        $_productTypeModels = [
            $rowData[\Magento\MuliaCatalogImport\Model\Import\Product::COL_TYPE] => 'value',
        ];
        $oldSku = [
            $sku => null,
        ];
        $_attrSetNameToId = [
            $rowData[\Magento\MuliaCatalogImport\Model\Import\Product::COL_ATTR_SET] => 'attr_set_code_val'
        ];
        $expectedData = [
            'entity_id' => null,
            'type_id' => $rowData[\Magento\MuliaCatalogImport\Model\Import\Product::COL_TYPE],//value
            //attr_set_id_val
            'attr_set_id' =>
                $_attrSetNameToId[$rowData[\Magento\MuliaCatalogImport\Model\Import\Product::COL_ATTR_SET]],
            'attr_set_code' => $rowData[\Magento\MuliaCatalogImport\Model\Import\Product::COL_ATTR_SET],//value
            'row_id' => null
        ];
        $importProduct = $this->createModelMockWithErrorAggregator(
            ['addRowError', 'getOptionEntity'],
    ...
    public function testValidateDefaultScopeNotValidAttributesResetSku()
    {
        ...
        $colStore = \Magento\MuliaCatalogImport\Model\Import\Product::COL_STORE;
        $scopeRowData = [
            $sku => 'sku',
            $colStore => null,
        ];
        $scopeResult = \Magento\MuliaCatalogImport\Model\Import\Product::SCOPE_DEFAULT;
        ...
        $attrRowData = [
            'code' => str_repeat(
                'a',
                \Magento\MuliaCatalogImport\Model\Import\Product::DB_MAX_VARCHAR_LENGTH + 1
            ),
        ];
    ...
    public function testValidateRowSetAttributeSetCodeIntoRowData()
    {
        ...
        $rowData = [
            \Magento\MuliaCatalogImport\Model\Import\Product::COL_SKU => $sku,
            \Magento\MuliaCatalogImport\Model\Import\Product::COL_ATTR_SET => 'col_attr_set_val',
        ];
        ...
        $expectedRowData = [
            \Magento\MuliaCatalogImport\Model\Import\Product::COL_SKU => $sku,
            \Magento\MuliaCatalogImport\Model\Import\Product::COL_ATTR_SET => $newSku['attr_set_code'],
        ];
        $oldSku = [
            $sku => [
                'type_id' => 'type_id_val',
    ...
    public function testValidateValidateOptionEntity()
    {
        ...
        $option = $this->getMockBuilder(\Magento\MuliaCatalogImport\Model\Import\Product\Option::class)
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function validateRowValidateNewProductTypeAddRowErrorCallDataProvider()
    {
        return [
            [
                ...
                '$error' => \Magento\MuliaCatalogImport\Model\Import\Product\Validator::ERROR_INVALID_TYPE
            ],
            [
                '$colType' => 'value',
            ...
            [
                ...
                '$error' => \Magento\MuliaCatalogImport\Model\Import\Product\Validator::ERROR_INVALID_ATTR_SET,
            ],
            [
                '$colType' => 'value',
                '$productTypeModelsColType' => 'value',
    ...
    public function validateRowCheckSpecifiedSkuDataProvider()
    {
        return [
            [
                '$sku' => null,
                '$expectedError' => \Magento\MuliaCatalogImport\Model\Import\Product\Validator::ERROR_SKU_IS_EMPTY,
            ],
            [
                '$sku' => false,
                '$expectedError' => \Magento\MuliaCatalogImport\Model\Import\Product\Validator::ERROR_ROW_IS_ORPHAN,
            ],
            [
                '$sku' => 'sku',
                '$expectedError' => \Magento\MuliaCatalogImport\Model\Import\Product\Validator::ERROR_INVALID_STORE,
            ],
        ];
    }
    ...
    public function validateRowDataProvider()
    {
        return [
            [
                '$rowScope' => \Magento\MuliaCatalogImport\Model\Import\Product::SCOPE_DEFAULT,
                '$oldSku' => null,
        ...
        return [
            ...
            [
                ...
                '$rowData' => [
                    'code' => str_repeat(
                        'a',
                        \Magento\MuliaCatalogImport\Model\Import\Product::DB_MAX_TEXT_LENGTH - 1
                    ),
                ],
            ],
        ];
    ...
    {
        $colSku = \Magento\MuliaCatalogImport\Model\Import\Product::COL_SKU;
        $colStore = \Magento\MuliaCatalogImport\Model\Import\Product::COL_STORE;
        ...
        return [
            [
                ...
                '$expectedResult' => \Magento\MuliaCatalogImport\Model\Import\Product::SCOPE_STORE
            ],
            [
                '$rowData' => [
                    $colSku => 'sku',
     ...
     * @param \Magento\MuliaCatalogImport\Model\Import\Product
     *  Param should go with rewritten getOptionEntity method.
     * @return \Magento\MuliaCatalogImport\Model\Import\Product\Option|\PHPUnit_Framework_MockObject_MockObject
     */
     ...
     *
     * @param \Magento\MuliaCatalogImport\Model\Import\Product
     * @return \Magento\MuliaCatalogImport\Model\Import\Product\Validator|\PHPUnit_Framework_MockObject_MockObject
     */
