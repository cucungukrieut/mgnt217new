 ...
 */
namespace Magento\MuliaCatalogImport\Test\Unit\Model\Indexer\Stock\Plugin;
...
class ImportTest extends \PHPUnit_Framework_TestCase
{
    public function testAfterImportSource()
    {
        ...
        $model = new \Magento\MuliaCatalogImport\Model\Indexer\Stock\Plugin\Import($processorMock);
