 ...
 */
namespace Magento\MuliaCatalogImport\Test\Unit\Model\Indexer\Product\Flat\Plugin;
...
class ImportTest extends \PHPUnit_Framework_TestCase
{
    public function testAfterImportSource()
    {
        ...
        $model = new \Magento\MuliaCatalogImport\Model\Indexer\Product\Flat\Plugin\Import($processorMock);
