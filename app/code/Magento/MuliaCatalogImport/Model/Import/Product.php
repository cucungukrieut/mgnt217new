...
namespace Magento\MuliaCatalogImport\Model\Import;

use Magento\Framework\App\Filesystem\DirectoryList;
use Magento\MuliaCatalogImport\Model\Import\Product\RowValidatorInterface as ValidatorInterface;
...
class Product extends \Magento\ImportExport\Model\Import\Entity\AbstractEntity
{
     ...
     *
     * @var \Magento\MuliaCatalogImport\Model\Import\Uploader
     */
    ...
    /**
     * @var \Magento\MuliaCatalogImport\Model\Import\Proxy\Product\ResourceModelFactory
     */
    protected $_resourceFactory;

    /**
     * @var \Magento\MuliaCatalogImport\Model\Import\Proxy\Product\ResourceModel
     */
    protected $_resource;
    ...
    /**
     * @var \Magento\MuliaCatalogImport\Model\Import\Product\Type\Factory
     */
    ...
    /**
     * @var \Magento\MuliaCatalogImport\Model\Import\Proxy\ProductFactory
     */
    protected $_proxyProdFactory;

    /**
     * @var \Magento\MuliaCatalogImport\Model\Import\UploaderFactory
     */
    ...
    public function __construct(
        ...
        \Magento\MuliaCatalogImport\Model\Import\Proxy\Product\ResourceModelFactory $resourceFactory,
        \Magento\MuliaCatalogImport\Model\Import\Product\OptionFactory $optionFactory,
        \Magento\Eav\Model\ResourceModel\Entity\Attribute\Set\CollectionFactory $setColFactory,
        \Magento\MuliaCatalogImport\Model\Import\Product\Type\Factory $productTypeFactory,
        \Magento\Catalog\Model\ResourceModel\Product\LinkFactory $linkFactory,
        \Magento\MuliaCatalogImport\Model\Import\Proxy\ProductFactory $proxyProdFactory,
        \Magento\MuliaCatalogImport\Model\Import\UploaderFactory $uploaderFactory,
     ...
     *
     * @return \Magento\MuliaCatalogImport\Model\Import\Product\Option
     */
    ...
    public function getMediaGalleryAttributeId()
    {
        if (!$this->_mediaGalleryAttributeId) {
            /** @var $resource \Magento\MuliaCatalogImport\Model\Import\Proxy\Product\ResourceModel */
    ...
    protected function _initTypeModels()
    {
        ...
        foreach ($productTypes as $productTypeName => $productTypeConfig) {
            ...
            if (!$model instanceof \Magento\MuliaCatalogImport\Model\Import\Product\Type\AbstractType) {
                throw new \Magento\Framework\Exception\LocalizedException(
                    __(
     ...
     *
     * @return \Magento\MuliaCatalogImport\Model\Import\Uploader
     * @throws \Magento\Framework\Exception\LocalizedException
     */
     ...
     *
     * @return \Magento\MuliaCatalogImport\Model\Import\Product\CategoryProcessor
     */
